...
class CELogViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        creditLogTableView.register(UINib(nibName: "CECreditDetailCell", bundle: nil), forCellReuseIdentifier: "ReusableCreditCell")
    }
...
extension CELogViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ReusableCreditCell", for: indexPath) as! CECreditDetailCell
        ...
        cell.cellBubble.backgroundColor = viewModel.getCellColorFor(topic: credit.topicDesignator).withAlphaComponent(0.5)
